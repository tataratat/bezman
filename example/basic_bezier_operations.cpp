...
int main() {
  ...
  const auto test0 =
      (line1.order_elevate_along_parametric_dimension(0) + line2);
  const auto test1 =
  ...
  //   static_cast<double>(RAND_MAX)}; const auto eval_point =
  //   line_product.evaluate(Point<1, double>{x}); const auto eval_point1 =
  //   line0.evaluate(Point<1, double>{x}); const auto eval_point2 =
  //   line1.evaluate(Point<1, double>{x});
